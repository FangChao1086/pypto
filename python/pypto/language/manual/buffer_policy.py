...
class BufferType(Enum):
    """Buffer type enumeration matching ops-transformer BufferType."""
    L1 = "L1"
    L0C = "L0C"
    L0A = "L0A"
    L0B = "L0B"
...
class BuffersPolicyDB:
    ...
    Example::
        ...
        tile_type = TileType(shape=[64, 128], dtype=FP16, target_memory=MemorySpace.UB)
        policy = BuffersPolicyDB(UB, SyncType.CROSS_CORE_SYNC_BOTH)
...
class BuffersPolicy3buff:
    ...
    Example::
        ...
        tile_type = TileType(shape=[64, 128], dtype=FP16, target_memory=MemorySpace.L1)
        policy = BuffersPolicy3buff(tile_type, BufferType.L1, SyncType.INNER_CORE_SYNC)
...
class BuffersPolicy4buff:
    ...
    Example::
        ...
        tile_type = TileType(shape=[64, 64], dtype=FP32, target_memory=MemorySpace.L0C)
        policy = BuffersPolicy4buff(tile_type, BufferType.L0C, SyncType.INNER_CORE_SYNC)
...
class BuffersPolicySingleBuffer:
    ...
    Example::
        ...
        policy = BuffersPolicySingleBuffer(tile_type, BufferType.UB, SyncType.INNER_CORE_SYNC)
