...
from pypto.language.op.manual import TileType, make_tile
...
class BuffersPolicyDB:
    ...
    def sync_inner(self, pipeline: Optional[Union[str, "PipelineType"]] = None):
...
class BuffersPolicySingleBuffer:
    ...
    def free(self) -> None:
        ...
        Corresponds to pto-isa's ubBufSync.free().
        """
        from pypto.language.manual.sync import free_buffer
        free_buffer(self._id1)
